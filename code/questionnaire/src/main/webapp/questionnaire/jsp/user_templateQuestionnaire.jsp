...
<html lang="zh-CN">
  ...
  <body>
    <div class="container">
		      <a  class="btn btn-default" href="FrontPage" type="button" >
			<i class="fa fa-mail-reply fa-2x">返回首页</i>
			
		</a>
		<%if(request.getParameter("quesid")==null){%>
	<%}else{%>
	<button style='float:right' class="btn btn-default" type="button" id="copytem">
			<i class="fa fa-2x">使用此模板创建问卷</i>
